...
const char * MD5::getStringHash()
{
	...
	for (size_t i = 0; i < BytesHashLength; i++)
	{
	    sprintf(_str_digest + 2*i, "%02x", _digest[i]);
	}
	_str_digest[sizeof(_str_digest)-1] = 0;
